function [sensitivity, specificity] = linear_eval(X,d,w,test)
%  [sensitivity, specificity] = linear_eval(X,d,w,test)
...
%   w   linear weights
%   test optional, specifies boundary threshold (default 0.5) 
% Outputs
...
x2 = -w(1)*x1/w(2) + (-w(3)+.5)/w(2);   % Calculate x2 using Eq. (9)
