function mse = net_eval_4(X,d,W1,b1,W2,b2,W3,b3)
...
[dum,nu_hl1] = size(W1);     % Determine number of hidden neurons
[dum,nu_ol] = size(d);     % Determine number of output neurons
